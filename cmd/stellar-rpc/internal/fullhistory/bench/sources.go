...
// implementations expose backfill.Backend — the production bulk-source seam
// RunBackfill's freeze path consumes — keeping benchmark drivers independent of
...
// coverage waits pass immediately and a genuinely missing pack surfaces as
// RawLedgers' clear open error instead of a coverage timeout.
