...
// NewRegistry binds a bare Registry to the catalog and retention policy: an
// empty handle map and latest ledger zero. The daemon uses OpenRegistry; this
// is the seam for callers that publish their own state, such as tests and the
// bench's cold query fixture.
