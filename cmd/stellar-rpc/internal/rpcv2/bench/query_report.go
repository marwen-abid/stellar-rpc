...
const (
	queryRowTotalPrefix          = "total"
	queryRowServicePrefix        = "service"
	...
	driverLegOfferedSuffix       = "_arrival" // legResult.offered; "arrival" is the published label
...
// rateRow names label's row for the leg at rps.
