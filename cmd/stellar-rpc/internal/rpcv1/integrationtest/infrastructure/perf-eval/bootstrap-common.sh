...
# Ubuntu 22.04 ships awscli as an apt package; 24.04 does not, so fall back to the
# AWS CLI v2 bundle. Failures before this point cannot publish a verdict; the
# poller's budget deadline catches them.
